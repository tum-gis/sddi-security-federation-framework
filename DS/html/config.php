...
$commonDomain = '.sddi.secure-dimensions.de';
...
$metadataFile = '/opt/discovery-service/metadata.xml';
...
// the WAYF script.
$imageURL = 'https://ds.sddi.secure-dimensions.de/images';

// Absolute URL to point to css directory
// The default assumes that this is in the same directory like
// the WAYF script.
$cssURL = 'https://ds.sddi.secure-dimensions.de/css';

// Absolute URL to point to javascript directory
// The default assumes that this is in the same directory like
// the WAYF script.
$javascriptURL = 'https://ds.sddi.secure-dimensions.de/js';
...
$instanceIdentifier = 'SDDI Federation';
...
$federationURL = 'http://www.tum.de';

// Absolute URL to the federation logo that should be displayed in the Embedded WAYF
// Set to an empty string to hide the logo
$logoURL = 'https://ds.sddi.secure-dimensions.de/images/federation-logo.png';
...
$smallLogoURL = 'https://ds.sddi.secure-dimensions.de/images/small-federation-logo.png';

// Support contact email address
$supportContactEmail = 'support@secure-dimensions.de';

// Absolute URL to the logo of the organization operating this Discovery Service
// Set to an empty string to hide the logo
$organizationLogoURL = 'https://ds.sddi.secure-dimensions.de/images/organization-logo.png'; 

// Absolute URL to the organization's web page
// Insert %s as macro to be substituted by the language (e.g. 'en', 'de', 'fr', ...) the WAYF uses
$organizationURL = 'https://www.secure-dimensions.de'; 
