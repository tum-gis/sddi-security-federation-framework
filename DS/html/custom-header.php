...
<head>
	...
	function preventIframeEmbedding(){
		// Andreas Matheus: Fix to allow HelloJS use out of the box...
		//if (top != self) {
...
<div id="container">
	<div class="box">
		<div id="header">
			...
			<a href="<?php echo sprintf($federationURL, $language) ?>"><img height="100" src="<?php echo $logoURL ?>" alt="Federation Logo" id="federationLogo"></a>
			<?php } ?>
			<?php if (!empty($organizationLogoURL)) { ?>
			<a href="<?php echo sprintf($organizationURL, $language) ?>"><img height="100" src="<?php echo $organizationLogoURL ?>" alt="Organization Logo" id="organisationLogo"></a>
			<?php } ?>
		</div>
			<div id="content">
				<ul class="menu">
